defmodule LeafNode.Core.Ets do
  ...
  """
  def create_table(table \\ :documents, opts) do
    :ets.new(table, opts)
  end
  ...
  """
  def insert(table \\ :documents, key, value) do
  ...
  """
  def get_by_key(table \\ :documents, key) do
  ...
  """
  def get_all(table \\ :documents) do
  ...
  """
  def delete_by_key(table \\ :documents, key) do
