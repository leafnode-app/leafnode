defmodule LeafNodeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LeafNodeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LeafNodeWeb.Gettext, "errors", msg, opts)
    end
  end
